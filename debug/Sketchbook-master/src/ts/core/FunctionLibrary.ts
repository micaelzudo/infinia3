...
{
	if (!v1 || !v2) {
		console.error("getAngleBetweenVectors called with undefined vector(s):", v1, v2);
		// Optionally, log the stack trace here: console.trace();
		return 0; // Return a default value
	}

	let dot = v1.dot(v2);

	// If dot is close to 1, vectors are parallel
