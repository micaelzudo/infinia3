...
export function initIsolatedViewer(container: HTMLDivElement) {
    ...
    console.log("[Viewer Init] Added ambient light");
    ...
    scene!.add(mainLight);
    console.log("[Viewer Init] Added main directional light");

    // Fill light
    const fillLight = new THREE.DirectionalLight(0xffffff, 0.3);
    fillLight.position.set(-5, 3, -5);
    scene!.add(fillLight);
    console.log("[Viewer Init] Added fill light");

    // Rim light
    const rimLight = new THREE.DirectionalLight(0xffffff, 0.2);
    rimLight.position.set(0, 5, -5);
    scene!.add(rimLight);
    console.log("[Viewer Init] Added rim light");
